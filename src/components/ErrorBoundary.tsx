  ...
  render() {
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, background: color.bg, fontFamily: font.body }}>
        <div style={{ maxWidth: 460, textAlign: "center", background: "#fff", border: `1px solid ${color.border}`, borderRadius: 16, padding: "36px 32px", boxShadow: "0 12px 40px rgba(20,26,60,0.12)" }}>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
            ...
            <a href="/help?code=APP" style={{ fontSize: 13.5, fontWeight: 600, color: color.textMuted, background: "#fff", border: `1px solid ${color.border2}`, borderRadius: 10, padding: "10px 18px", textDecoration: "none" }}>Troubleshooting</a>
          </div>
        </div>
      </div>
    );
