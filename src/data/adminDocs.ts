...
export const EVALUATION: Evaluation = {
  ...
  scorecard: [
    ...
    { n: 2, name: "Architecture & modularity", stars: 5, evidence: "Modular monolith; minimal API grouped /api/v1; one C# file per domain; HLD + LLD + 53 ADRs.", gaps: "—" },
    ...
    { n: 17, name: "Documentation", stars: 5, evidence: "HLD, LLD, building-blocks (ABB/SBB), 53 ADRs, in-app Help, setup guides, this evaluation, user stories.", gaps: "—" },
  ...
  risks: [
    { priority: "Low", item: "Commission a human pen-test + automate secret rotation", why: "SAST/SCA gate and DAST runs on demand (ADR-0051/0053); a human pen-test and automated secret rotation remain." },
