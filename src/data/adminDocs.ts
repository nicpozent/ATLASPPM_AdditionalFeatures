...
export const EVALUATION: Evaluation = {
  lastReviewed: "2026-07-09 · main @ ai-act-tiering",
  ...
  scorecard: [
    ...
    { n: 2, name: "Architecture & modularity", stars: 5, evidence: "Modular monolith; minimal API grouped /api/v1; one C# file per domain; HLD + LLD + 50 ADRs.", gaps: "—" },
    ...
    { n: 17, name: "Documentation", stars: 5, evidence: "HLD, LLD, building-blocks (ABB/SBB), 50 ADRs, in-app Help, setup guides, this evaluation, user stories.", gaps: "—" },
