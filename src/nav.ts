...
export const ROLES: RoleIdentity[] = [
  ...
  { value: "devapac",     label: "Dev APAC Manager",         name: "Wei Chen",         roleLabel: "Dev APAC Manager",       initials: "WC" },
  { value: "blogit",      label: "BLOG IT Manager",          name: "Ravi Menon",       roleLabel: "BLOG IT Manager",        initials: "RM" },
  { value: "inframgr",    label: "Infrastructure Manager",   name: "Erik Lindqvist",   roleLabel: "Infrastructure Manager", initials: "EL" },
  { value: "inframgr_apac", label: "Infrastructure Manager APAC", name: "Aiko Tanaka", roleLabel: "Infrastructure Manager APAC", initials: "AT" },
