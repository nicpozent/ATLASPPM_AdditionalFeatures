...
| SBB-14 | Security headers/CSP, rate limiter, upload limits, least-privilege DB role; **automated AppSec scanning — SAST (Semgrep) · SCA/secrets/IaC (Trivy) · DAST (OWASP ZAP)** in CI | ABB-09, ABB-12 | ADR-0008, ADR-0051, security-hardening.md |
