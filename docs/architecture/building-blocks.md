...
| SBB-15 | Governance modules (Gates, RAID, Architecture ADM/ARB, Security controls, Decisions, Quality) + GDPR/retention; **deterministic risk engine** (`Risks.cs`, no LLM) mapping findings to GDPR/ISO 27001/ISO 42001/PCI-DSS/SOC 2/NIS2/NIST CSF/MITRE ATT&CK with a generic per-framework coverage rule; **Zero-Trust posture** mapping (ADR-0049) | ABB-10, ABB-09 | ADR-0049 |
