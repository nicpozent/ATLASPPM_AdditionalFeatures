...
| 2 | **Architecture & modularity** | ★★★★★ | Modular monolith, minimal API grouped `/api/v1`; one C# file per domain; HLD + LLD + 55 ADRs | — |
...
| 17 | **Documentation** | ★★★★★ | HLD, LLD, building-blocks (ABB/SBB), 55 ADRs, in-app Help + **Security Posture** page, setup guides, this evaluation, user stories | — |
